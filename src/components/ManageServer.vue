    ...
    <div>
        ...
        <div class="body">
            <el-table :data="tableData" style="width: 89%" class="table">
                <el-table-column prop="service_id" label="收费项目" width="200" align="center">
                </el-table-column>
                <el-table-column prop="service_name" label="收费金额" width="200" align="center">
                </el-table-column>
                <el-table-column prop="fastfood_shop_name" label="所属年级" width="200" align="center">
                </el-table-column>
                <el-table-column prop="operate" label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button size="small" type="danger" @click="showdia_dlt(scope.row)">删除缴费
                        </el-button>
                    </template>
                </el-table-column>
                <el-table-column width="120" align="center">
                    <template slot="header">
                        <el-button icon="el-icon-plus" size="small" type="success" @click="showdia_add()">添加缴费类型
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>

            <el-dialog title="添加收费项目" :visible.sync="dia_add" width="30%">
                <el-form ref="add_form" :model="add_form" label-width="120px" :rules="add_form_rules">
                    <el-form-item label="项目名称：" prop="service_id">
                        <el-input v-model="add_form.service_id"></el-input>
                    </el-form-item>
                    <el-form-item label="收费金额：" prop="service_name">
                        <el-input v-model="add_form.service_name"></el-input>
                    </el-form-item>
                    <el-form-item label="所属年级：" prop="fastfood_shop_name">
                        <el-select v-model="add_form.fastfood_shop_name" placeholder="请选择年级区域">
