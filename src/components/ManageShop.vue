<template>
    <div>
        ...
        <div class="body">
            ...
            <el-dialog title="添加缴费类型" :visible.sync="dia_add" width="30%">
                <el-form ref="add_form" :model="add_form" label-width="100px" :rules="add_form_rules">
                    <el-form-item label="专业名称：" prop="shop_name">
                        <el-input v-model="add_form.shop_name"></el-input>
                    </el-form-item>
                    <el-form-item label="应缴费用：" prop="price">
                        <el-input v-model="add_form.price"></el-input>
                    </el-form-item>
                    <el-form-item label="已缴人数：" prop="m_sale_v">
            ...
            <el-dialog title="修改信息" :visible.sync="dia_chg" width="30%">
            ...
            <el-dialog title="删除缴费" :visible.sync="dia_dlt" width="30%">
                <div>
                    确定删除此项目吗？
                </div>
                <div style="text-align: center;">
